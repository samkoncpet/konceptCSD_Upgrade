...
export class GridComponent implements OnDestroy {
  columnDefs = [
      ...
      //   width: 52 
      // },
      { field: 'id', headerName: 'Sr. No.', sortable: true, editable: false, },
      { field: 'name', headerName: 'Group', sortable: true, editable: true },
      { field: 'note', headerName: 'User Name', sortable: true, editable: true },
      { field: 'stock', headerName: 'Full Name', sortable: true, editable: true },
      { field: 'ship', headerName: 'Email', sortable: true, editable: true },
      { field: 'sdate', headerName: 'Mobile No.', sortable: true, editable: true } 
  ]

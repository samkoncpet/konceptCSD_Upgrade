...
@Component({
  selector: 'app-cell-custom-packagelist',
  templateUrl: './cell-custom-packagelist.component.html',
  styleUrls: ['./cell-custom-packagelist.component.css']
})
export class CellCustomPackagelistComponent implements OnInit {
  data: any;
  params: any;
  id: string = "";
  ...
  constructor(private http: HttpClient, private router: Router,    
    ...
    public _packagelistComponent: PackagelistComponent) {    
  }
  agInit(params) {
    this.params = params;
  ...
  delete(){
    ...
    var deletePackageAPI = this._appSettings.deletePackageAPI;
    url = url + deletePackageAPI;
